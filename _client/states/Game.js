    ...
    attackEnemy = function(id){
        ...
        Object.keys(this.playerMap).forEach(enemy => {
            if(this.playerMap[enemy] !== this.playerMap[id]){
             ...
             } else if((Math.abs(playerLocation.y - enemyLocation.y ) < 8) && (Math.abs(playerLocation.x - enemyLocation.x ) < 8) && this.playerMap[enemy].width > this.playerMap[id].width && (this.playerMap[enemy].width - this.playerMap[id].width) <= 40 && this.playerMap[enemy].teamName !== this.playerMap[id].teamName){
